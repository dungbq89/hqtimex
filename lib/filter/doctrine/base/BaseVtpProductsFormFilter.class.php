...
abstract class BaseVtpProductsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'reference_price'      => new sfWidgetFormFilterInput(),
      ...
      'supply_ability'       => new sfWidgetFormFilterInput(),
      'packing'              => new sfWidgetFormFilterInput(),
      'special_req'          => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'brand'                => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'reference_price'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'supply_ability'       => new sfValidatorPass(array('required' => false)),
      'packing'              => new sfValidatorPass(array('required' => false)),
      'special_req'          => new sfValidatorPass(array('required' => false)),
