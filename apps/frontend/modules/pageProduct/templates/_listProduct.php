...
<!--                                                --><?php //echo (!empty($product->price_promotion)) ? sprintf('$%s', VtHelper::formatPrice($product->price_promotion)) : !empty($product->price) ? sprintf('$%s', VtHelper::formatPrice($product->price)) : __('Contact supplier') ?>
<!--                                            </span>-->
