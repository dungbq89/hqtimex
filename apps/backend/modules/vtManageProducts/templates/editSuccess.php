            ...
            <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
                ...
                <div id="sf_admin_content">
                    <form class="form-inline" id="list-form"
                          action="<?php echo url_for('vtp_product_image_collection', array('action' => 'batch')) ?>"
                          method="post">
                            ...
                            <div class="well pull-left margin-right">
                                <div class="btn-group">
                                    <a class="btn btn-success"
                                       href="<?php echo url_for('vtp_product_image_new', array('default_product_id' => $vtp_products->getPrimaryKey())) ?>">
                    ...
                    <form class="form-inline" method="get"
                          action="<?php echo url_for('vtp_products_edit', $vtp_products) ?>">
                        <div class="well pull-right">
                            ...
                            echo $select->render('max_per_page', $sf_user->getAttribute('vtpManageProductImage.max_per_page', null, 'admin_module')) ?>
